...
# =====================================================
# 3. CSS GIAO DIỆN (BẢN TINH TẾ - KHÔNG POPUP)
# =====================================================
st.markdown("""
<style>
    ...
    .limit-title { font-size: 20px; font-weight: bold; color: #00796b; margin-bottom: 8px; }
    .limit-desc { font-size: 14px; color: #666; margin-bottom: 20px; line-height: 1.5; }
    ...
    /* Nút Zalo đẹp */
    .zalo-btn { display: flex !important; align-items: center; justify-content: center; width: 100%; background-color: #0f988b; color: white !important; border: none; border-radius: 8px; font-weight: bold; font-size: 14px; height: 40px !important; text-decoration: none !important; margin-top: 10px !important; }
    
    div[data-testid="stForm"] { border: none !important; padding: 0 !important; box-shadow: none !important; }
    div[data-testid="stForm"] button { height: 40px !important; border-radius: 8px !important; font-weight: 500 !important; color: #31333F !important; background-color: #f0f2f6; width: 100%; }
    div[data-testid="stForm"] button:hover { background-color: #e0e0e0; }
...
# =====================================================
# 6. FORM ĐĂNG NHẬP (TÍCH HỢP TRONG LIMIT CONTAINER)
# =====================================================
def render_limit_and_login():
    ...
    <div class="limit-container">
        ...
        <div class="limit-desc">
            ...
            Vui lòng đăng nhập Member để tiếp tục.
        </div>
    """, unsafe_allow_html=True)
    
    # Form đăng nhập nằm ngay trong container
...
# --- XỬ LÝ HẾT LƯỢT (HIỆN CONTAINER TÍCH HỢP LOGIN) ---
if not can_chat:
    render_limit_and_login()
    st.stop()

# XỬ LÝ CHAT (LOGIC V9 ỔN ĐỊNH)
...
# (Phần nút đăng nhập dự phòng dưới cùng đã bỏ vì form đã tích hợp ở trên)
